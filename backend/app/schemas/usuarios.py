...
class createUsuarioRequest(BaseModel):
    ...
    rol: str = Field(..., pattern="^(admin|contador|gerente_ventas|vendedor|operario|readonly)$")

class updateUsuarioRequest(BaseModel):
    nombre: Optional[str] = None
    apellido: Optional[str] = None
    rol: Optional[str] = Field(None, pattern="^(admin|contador|gerente_ventas|vendedor|operario|readonly)$")
